...
const cors = require("cors"); // ⬅️ 1. 引入 cors 包
...
// 2. 配置 cors 中间件
const corsOptions = {
  origin: "https://localhost:3000", // 只允许来自你的前端的请求
  methods: "GET,POST,OPTIONS",          // 允许的方法
  allowedHeaders: "Content-Type,X-API-KEY", // 允许的自定义请求头
  credentials: true,                    // 允许凭据
};

app.use(cors(corsOptions)); // ⬅️ 3. 使用配置好的 cors 中间件
